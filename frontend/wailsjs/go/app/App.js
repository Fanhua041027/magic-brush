...
export function AudioCaptureWithEnhancement(arg1, arg2) {
  return window['go']['app']['App']['AudioCaptureWithEnhancement'](arg1, arg2);
}

export function AudioGetBestDevice() {
  return window['go']['app']['App']['AudioGetBestDevice']();
}
